...
export default function AdminProductsPage() {
  ...
  const resetForm = () => {
    setFormData({
      title: '', description: '', category: 'poultry', featured: false,
      price: '', weight: '', brand: '',
      nutritionalInfo: {
        servingSize: '', calories: '', fat: '', saturatedFat: '', transFat: '',
        cholesterol: '', sodium: '', carbohydrates: '', fiber: '', sugars: '',
        protein: '', fatPercentage: '', saturatedFatPercentage: '', transFatPercentage: '',
        cholesterolPercentage: '', sodiumPercentage: '', carbohydratesPercentage: '',
        fiberPercentage: '', sugarsPercentage: '', proteinPercentage: ''
      },
  ...
  const handleEdit = (product: IProduct) => {
    setFormData({
      ...
      specifications: product.specifications || {
        brand: '', weight: '', origin: '', certification: ''
      },
      imageFile: null
    });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const productData = {
      ...
      nutritionalInfo: Object.values(formData.nutritionalInfo).some(v => v.trim()) ? formData.nutritionalInfo : undefined,
      specifications: Object.values(formData.specifications).some(v => v.trim()) ? formData.specifications : undefined,
          ...
          {products.map((product) => (
            <div key={product._id} className="bg-white rounded-lg shadow-sm border overflow-hidden">
              ...
              <div className="aspect-square relative bg-gray-100">
                <Image
                  src={product.image ? getServerUrl(product.image) || "/square_placeholder.webp" : "/square_placeholder.webp"}
                  alt={product.title}
                  fill
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between text-sm text-gray-500 mb-3">
                  ...
                  {product.price && <span className="font-medium text-green-600">{product.price}</span>}
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">المنشأ</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">الشهادة</label>
                      <input
                        type="text"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">حجم الحصة</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">الدهون الكلية</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">البروتين</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">الكربوهيدرات</label>
                      <input
                        type="text"
                        value={formData.nutritionalInfo.carbohydrates}
                        onChange={(e) => setFormData(prev => ({ 
                          ...prev, 
                          nutritionalInfo: { ...prev.nutritionalInfo, carbohydrates: e.target.value }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">الصوديوم</label>
                      <input
                        type="text"
                        value={formData.nutritionalInfo.sodium}
                        onChange={(e) => setFormData(prev => ({ 
                          ...prev, 
                          nutritionalInfo: { ...prev.nutritionalInfo, sodium: e.target.value }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                      />
                    </div>
