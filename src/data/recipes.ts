...
export const recipes: Recipe[] = [
	...
	},
	{
		...
		steps: [
			"اطعِ الخضار واطهِها في المرق",
			"أضف السمك واطهِ حتى ينضج",
			"تتبيل وقدّم ساخناً",
		],
	},
	{
		...
		steps: [
			"اغلِ التمر مع الماء حتى يطرى",
			"اخلطه ثم أعده للقدر",
			"أضف السكر واطهه حتى يثخن",
		],
	},
	{
		...
		steps: [
			"قلِّ البصل والثوم",
			"أضف الدجاج والكاري ثم التمر",
			"أضف الكريمة واتركه يتكاثف",
		],
	},
	{
		...
		steps: [
			"تبّل السمك بالليمون والثوم",
			"اشوه في الفرن حتى النضج",
			"قدّم مباشرة",
		],
	},
	{
