      ...
      <div className="border-b border-gray-200 p-2 flex flex-wrap items-center gap-1 bg-gray-50 rounded-t-md">
        ...
        <div className="flex items-center gap-1 border-r border-gray-300 pr-2 mr-2">
          <button
            type="button"
            onClick={() => {
              console.log('Bullet list clicked, current state:', editor.isActive('bulletList'));
        ...
        <div className="flex items-center gap-1 border-r border-gray-300 pr-2 mr-2">
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-1 p-2 bg-white border border-gray-200 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
              <div className="grid grid-cols-6 gap-1">
                {[
                  '#000000', '#374151', '#6B7280', '#EF4444', '#F59E0B', '#10B981',
                  '#3B82F6', '#8B5CF6', '#EC4899', '#F97316', '#84CC16', '#06B6D4'
                ].map((color) => (
                  <button
                    key={color}
                    type="button"
