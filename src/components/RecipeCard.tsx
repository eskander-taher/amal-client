...
const RecipeCard: React.FC<RecipeCardProps> = ({
	...
	return (
		<TransitionLink
			...
			className="block"
		>
			<div className="bg-white group p-3 rounded-lg overflow-hidden relative cursor-pointer h-full flex flex-col hover:scale-105 transition-transform duration-300">
