...
import type { HeroSlide } from "@/lib/serverApi";
...
const Hero: React.FC<HeroProps> = ({ slides }) => {
	...
	// Fallback carousel slides if no data
	const fallbackSlides = [
		{
			...
			title:
				local === "ar"
					? "مرحبًا بكم في مجموعة أمل الخير القابضة"
					: "Welcome to Amal Al Khair Holding Group",
			description:
				local === "ar"
					? "اكتشف المنتجات عالية الجودة المصممة لتناسب احتياجاتك."
					: "Discover high-quality products designed to meet your needs.",
		...
		},
		{
			...
			description:
				local === "ar"
					? "استكشف مجموعة واسعة من منتجاتنا عالية الجودة المصممة لتلبية توقعاتك."
					: "Explore our wide range of high-quality products designed to meet your expectations.",
			buttonText: local === "ar" ? "المزيد" : "More",
			href: "/products",
		},
	];
		...
		<Section id="hero" className="relative w-full h-screen bg-black overflow-hidden">
				...
				<div className="flex flex-col justify-center w-full md:w-1/2 h-full px-12 sm:px-16 lg:px-24">
					...
					>
						...
						<TransitionLink
							...
							className={`relative group bg-white flex justify-between items-center text-black rounded-full font-bold text-sm sm:text-base lg:text-lg shadow-lg px-1.5 py-1 animate-fade-in-delay-2 transition-[width,background,shadow] duration-300 ease-in-out overflow-hidden w-[44px] h-[44px] hover:w-[110px] delay-150`}
						>
			...
			>
				<div
					...
					style={
						{ paddingInline: "30px", "--tab-color": "#111827" } as React.CSSProperties
					}
				>
